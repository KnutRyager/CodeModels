...
{
    public abstract record ClassModel(string Identifier, PropertyCollection Properties, List<Method> Methods,
        List<IType> Constants, Namespace? Namespace = null, bool IsStatic = false) : MethodHolder(Identifier, Properties, Methods, Namespace,
