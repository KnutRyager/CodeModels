...

{
    ...
    public List<IField> GetFields() => _fields ??= new List<IField>();
    ...
    public virtual IField GetField(string name) => GetFields().First(x => x.Name == name);
    public virtual IField? TryGetField(string name) => GetFields().FirstOrDefault(x => x.Name == name);
