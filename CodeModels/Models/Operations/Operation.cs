...
[Model]
public class Operation : IOperation<Namespace, DataType, OperationPipeline>
{
    ...
    IDataType IOperation.Output => Output;
    IOperationPipeline? IOperation.OperationPipeline => OperationPipeline;
    INamespace? IOperation.Namespace => Namespace;
