...
//        => Catch(syntax.Declaration is null ? TypeShorthands.VoidType : ParseType(syntax.Declaration.Type),
//            syntax.Declaration?.Identifier.ToString(), Parse(syntax.Block), CatchFilter(syntax.Filter));
