...
public static class ReflectionUtil
{
    ...
    public static bool IsSimplyfiableNullableType(Type type, bool nullable) => !IsNullable(type) && nullable;
    public static Type SimplifyNullableType(Type type, bool nullable) => IsSimplyfiableNullableType(type, nullable) ? GetNullableType(type) : type;
