...
namespace Common.Tests
{
    public class ReflectionUtilTests
    {
        ...
        [Fact] public void IsSimplyfiableNullableTypeNotNullable() => Assert.False(ReflectionUtil.IsSimplyfiableNullableType(typeof(int), false));
        [Fact] public void IsSimplyfiableNullableTypeAlreadyNullable() => Assert.False(ReflectionUtil.IsSimplyfiableNullableType(typeof(int?), true));
        [Fact] public void SimplifyNullableTypeTrue() => ReflectionUtil.SimplifyNullableType(typeof(int), true).Should().Be(typeof(int?));
        [Fact] public void SimplifyNullableTypeNotNullable() => ReflectionUtil.SimplifyNullableType(typeof(int), false).Should().Be(typeof(int));
        [Fact] public void SimplifyNullableTypeAlreadyNullable() => ReflectionUtil.SimplifyNullableType(typeof(int?), true).Should().Be(typeof(int?));
