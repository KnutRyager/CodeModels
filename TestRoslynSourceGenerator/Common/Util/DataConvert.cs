...
public static class DataConvert
{
    ...
    public static List<T> Table2Type<T>(List<List<string>> table) where T : new() => DataParsing.Parse<T>(table);
    ...
    public static List<T> Text2Type<T>(string text, string separator = Constants.DEFAULT_SEPARATOR) where T : new() => Table2Type<T>(Text2Table(text, separator));
