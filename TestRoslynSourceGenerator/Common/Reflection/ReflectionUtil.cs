...
public static class ReflectionUtil
{
    ...
    public static MethodInfo[] GetGenericMethods(Type type, string name, int? parameterCount = null, int? genericArgumentCount = null, Type?[]? parameters = null, Type[]? genericArguments = null, (int Param, int? GenericParam)[]? genericIndexOfParameters = null)
    {
        ...
        return type
         ...
         .Where(x =>
             ...
             && (parameters == null || parameters.Zip(x.Params).All(y => y.First == null || IsGenericParameterDescriptor(y.First) || y.First == y.Second.ParameterType)))
         .Select(x => x.Method)
         .ToArray();
    }
    ...
    public static bool IsNullable(Type type, PropertyInfo? property = null) => GetUnderlyingType(type) != null || (type == typeof(string) && (property == null || property.GetCustomAttribute<RequiredAttribute>() == null));
